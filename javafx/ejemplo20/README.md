...
public class EstudianteController {
    ...
    public void onReportesClick(ActionEvent actionEvent){
        try {
            Control source = (Control) actionEvent.getSource();
            Parent parent = FXMLLoader.load(
                    EstudianteController.class.getResource("/co/edu/uniquindio/ingesis/javafx/ejemplo/diplomado-reporte-view.fxml")
            );
            ...
            mostrarMensaje("Error interno: No es posible abrir la interfaz de reportes");
            e.printStackTrace();
        }
    }
}
...
### MessageFXUtil
Clase utilitaria que permite mostrar mensajes al usuario.
...
### PersistenciaUtil
Clase utilitaria para el almacenamiento y recuperación de información desde archivos.
...
### diplomado-reporte-view.fxml
Representa la venta. Actualmente, una ventana con una tabla, campos de texto para el ingreso de datos del reporte y los botones para la interacción del usuario.
La ventana apunta a la clase ReporteController como controlador de la ventana.
